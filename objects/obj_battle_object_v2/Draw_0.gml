...
for(var _i = 0; _i < enemy_amount; _i++)
{
	...
	if(enemy_hurt_animation_activation && selected_enemy == _i)
	{
	enemy_hurt_percent += 1/60;
	if(enemy_hurt_percent > 1.2){enemy_hurt_animation_activation=false; enemy_hurt_percent = 0;}//enemy_hurt_percent -=1};
	...
	draw_sprite(_enemy.sprite, -1, _enemy._x , _enemy_y);
	if(enemy_amount > 1)
	{
		_enemy_x += 90
	}
